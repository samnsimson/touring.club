...
| Client | Stack                    | Status                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------ | ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Web    | Next.js, TypeScript      | In progress — `apps/frontend/web` (`@nx/next:app`, App Router, tag `scope:frontend`); Chakra UI shell; full auth flow (`/login`, `/register`, `/verify-email`, `/forgot-password`, `/reset-password`) wired to real `auth-service` via `@tc/client-api`; trips also wired to real `trips-service` (`/trips`, `/trips/[tripId]`, homepage featured trips, `/destinations/[id]` trips list, `/dashboard/trips`); everything else (`/destinations`, `/about`, `/dashboard` overview, `/dashboard/trips/joined`, `/messages`, `/notifications`, `/profile`) still renders against `@tc/mocks` pending real API integration; `/settings` is a placeholder |
