import { Body, Controller, Delete, Get, Headers, HttpStatus, Param, Patch, Post, Query, UploadedFile } from '@nestjs/common';
...
export class AppController {
    ...
    async approveMembership(
        ...
        return this.appService.approveMembership(userId, tripId, membershipId, authorization);
    }
    ...
    async removeMembership(
        ...
        return this.appService.removeMembership(userId, tripId, membershipId, authorization);
    }
